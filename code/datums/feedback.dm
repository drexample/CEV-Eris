var/datum/blackbox_datum/blackbox_datum = new

/datum/blackbox_datum
...
/datum/blackbox_datum/Destroy()
	log_admin("[type] was deleted, why would you do this?")
	..()

/datum/blackbox_datum/proc/find_feedback_datum(var/variable)
...
/datum/blackbox_datum/proc/round_end_data_gathering()
/*	var/pda_msg_amt = 0
	var/rc_msg_amt = 0
...
/datum/blackbox_datum/proc/save_all_data_to_sql()
	if(!feedback)
		return

	//#warn blackbox_datum recording disabled.  Please remove warning once this has been determined to be the problem.
	//return

	var/watch = start_watch()
	log_debug("Storing Black Box data...")
	...
	*/
	...
	log_debug("  Wrote Black Box data with [nqueries] queries in [stop_watch(watch)]s.")
...
/proc/feedback_set(var/variable,var/value)
	...
	var/datum/feedback_variable/FV = blackbox_datum.find_feedback_datum(variable)
