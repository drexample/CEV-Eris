...
/datum/dynamic/stat/dynamic_mode
...
/datum/dynamic/stat/dynamic_mode/proc/update_population(var/datum/gamemode/dynamic/mode)
	var/datum/dynamic/stat/pop_level/new_pop_level = new
...
/datum/dynamic/stat/dynamic_mode/proc/successful_injection(var/datum/dynamic_ruleset/ruleset)
	var/datum/dynamic/stat/successful_injection/new_injection = new
...
/datum/dynamic/stat/dynamic_mode/proc/measure_threat(var/new_threat)
	var/datum/dynamic/stat/threat_measure/new_threat_mesure = new
...
/datum/dynamic/stat/successful_injection
	var/time = ""
	var/name = ""

/datum/dynamic/stat/threat_measure
	var/time = ""
	var/threat = 0


// General role-related stats
/datum/dynamic/stat/role
	var/name = null
	var/faction_id = null
	var/mind_name = null
	var/mind_key = null
...
/datum/dynamic/stat/role/proc/generate_statistics(var/datum/role/R, var/victorious)
	name = R.name
	if(R.faction)
	...
	for(var/datum/objective/O in R.objectives.GetObjectives())
		objectives.Add(new /datum/dynamic/stat/role_objective(O))

/datum/dynamic/stat/role_objective
	var/obj_type = null
	var/name = null
	var/desc = null
...
/datum/dynamic/stat/role_objective/New(var/datum/objective/O)
	obj_type = O.type
	name = O.name
...
/datum/dynamic/stat/faction/proc/generate_statistics(var/datum/faction/F)
	id = F.ID
	name = F.name
	desc = F.desc
	faction_type = F.type
...
//NTODO	minor_victory = F.minor_victory
	victory = F.check_win()
/*
/datum/dynamic/stat/faction/malf
	var/list/datum/dynamic/stat/malf_module_purchase/modules = list()
	var/shunted = FALSE

/datum/dynamic/stat/malf_module_purchase
	var/typepath = null
	var/module_name = null
	var/cost = null

/datum/dynamic/stat/malf_module_purchase/New(var/datum/AI_Module/M)
	typepath = M.type
	module_name = M.module_name
	cost = M.cost

/datum/dynamic/stat/faction/blob
	...
	var/datum/dynamic/stat/faction_data/blob/structure_counts/built_structures = new

/datum/dynamic/stat/faction/blob/generate_statistics(var/datum/faction/blob_conglomerate/BF)
	..(BF)
...
/datum/dynamic/stat/faction_data/blob/structure_counts
	var/factories = 0
	var/nodes = 0
	var/resgens = 0
	var/shields = 0
...
/datum/dynamic/stat/role/wizard
	var/list/spellbook_purchases = list()

/datum/dynamic/stat/role/vampire
	var/list/powers = list()
	var/blood_total = 0

/datum/dynamic/stat/role/vampire/generate_statistics(var/datum/role/vampire/V)
	..(V)
	for(var/datum/power/P in V.powers)
		powers.Add(P.type)
	blood_total = V.blood_total

/datum/dynamic/stat/role/revolutionary
// future proofing don't mind me

/datum/dynamic/stat/role/revolutionary/leader
	var/recruits_converted = 0
	var/flashes_created = 0

/datum/dynamic/stat/role/ninja
	var/shuriken_thrown = 0
	var/times_charged_sword = 0
	var/stealth_posters_posted = 0

/datum/dynamic/stat/role/catbeast
	var/ticks_survived = 0
	var/threat_generated = 0
	var/threat_level_inflated = 0
	var/list/areas_defiled = list()

/datum/dynamic/stat/role/catbeast/generate_statistics(var/datum/role/catbeast/C)
	..(C)
